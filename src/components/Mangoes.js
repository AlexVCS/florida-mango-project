export const mangoArray = [
  {
    name: "Sweet Tart",
    image: "https://i.postimg.cc/zDcjj1Xj/sweet-tart.jpg",
    description:
      "Sweet tart mango was developed by the Zill Nursery in Boyton Beach, Florida. It's a seedling of Zill Indochinese and tastes like an amazing candy. Smooth and lives up to the name.",
  },
  {
    name: "Glenn",
    image: "https://i.postimg.cc/QCwJxcnP/glenn.jpg",
    description:
      "Glenn is a delicious mango that was brought to Miami in the 1940's. Such a smooth mango, just a delight!",
  },
  {
    name: "Cushman",
    image: "https://i.postimg.cc/4xMfjNQx/cushman.jpg",
    description:
      "Cushman is a big mango with an unusual round shape. Fiberless inside, the flavor is rich and sweet.",
  },
  {
